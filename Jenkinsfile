pipeline {
    ...
    stages {
        stage('git - clone') {
            steps {
                git branch: 'main', credentialsId: 'github-magikabdul', url: 'git@github.com:magikabdul/gatsby-adream-task.git'
            }
        }
        ...
        stage('deploy') {
            steps {
                sh 'sudo scp -P 5000 -i /home/kris/.ssh/wordic /var/lib/jenkins/workspace/gatsby-adream/public/*.* kris@wordic.it:/home/kris/jenkins_uploads/gatsby'
